...
public class WorldGenPlasmaTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = ModBlocks.P_LOG.getDefaultState();
	public static final IBlockState LEAF = ModBlocks.P_LEAVES.getDefaultState();
	
	
	public WorldGenPlasmaTree(boolean doBlockNotify) 
	{
        super(doBlockNotify);
    }
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= worldIn.getHeight())
        {
            ...
            else
            {
                ...
                if (state.getBlock().canSustainPlant(state, worldIn, down, net.minecraft.util.EnumFacing.UP, (com.viking2481.projectmod.blocks.metadata.BlockSaplings)ModBlocks.P_SAPLING) && position.getY() < worldIn.getHeight() - i - 1)
                {
