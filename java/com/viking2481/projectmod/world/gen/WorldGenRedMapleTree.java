...
public class WorldGenRedMapleTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = ModBlocks.M_LOG.getDefaultState();
	public static final IBlockState LEAF = ModBlocks.RM_LEAVES.getDefaultState();

	public WorldGenRedMapleTree(boolean doBlockNotify) 
	{
        super(doBlockNotify);
    }
