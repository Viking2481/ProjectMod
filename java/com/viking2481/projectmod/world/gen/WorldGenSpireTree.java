package com.viking2481.projectmod.world.gen;
...
public class WorldGenSpireTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = ModBlocks.SP_LOG.getDefaultState();
	public static final IBlockState LEAF = ModBlocks.SP_LEAVES.getDefaultState();
	
	
	public WorldGenSpireTree(boolean doBlockNotify) 
	{
        super(doBlockNotify);
    }
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= worldIn.getHeight())
        {
            ...
            else
            {
                ...
                if (state.getBlock().canSustainPlant(state, worldIn, down, net.minecraft.util.EnumFacing.UP, (com.viking2481.projectmod.blocks.metadata.BlockSaplings)ModBlocks.SP_SAPLING) && position.getY() < worldIn.getHeight() - i - 1)
                {
                    ...
                    for (int k4 = 0; k4 < i - i4; ++k4)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(worldIn, position.up(k4), LOG);
                        }
                    }
