...
public class WorldGenPinkMapleTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = ModBlocks.M_LOG.getDefaultState();
	public static final IBlockState LEAF = ModBlocks.PM_LEAVES.getDefaultState();

	public WorldGenPinkMapleTree(boolean doBlockNotify) 
	{
        super(doBlockNotify);
    }
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = state.getBlock().canSustainPlant(state, worldIn, down, net.minecraft.util.EnumFacing.UP, (com.viking2481.projectmod.blocks.metadata.BlockSaplings)ModBlocks.PM_SAPLING);
