...
public class ChunkGeneratorMerc implements IChunkGenerator
{
	//Block that replaces End Stone
	protected static final IBlockState MAIN_BLOCK = ModBlocks.M_GRASS.getDefaultState();
	protected static final IBlockState OTHER_BLOCK1 = ModBlocks.M_DIRT.getDefaultState();
    ...
    public ChunkGeneratorMerc(World world, boolean mapFeaturesEnabled, long seed, BlockPos spawn)
    {
        this.world = world;
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(ModBiomes.MERC);
        }
    ...
    public static float getIslandHeightValue(int x, int z, int p_185960_3_, int p_185960_4_)
    {
        ...
        for (int i = -12; i <= 12; ++i)
        {
            for (int j = -12; j <= 12; ++j)
            {
                ...
                if (k * k + l * l > 4096L && ChunkGeneratorMerc.islandNoise.getValue((double)k, (double)l) < -0.8999999761581421D)
                {
