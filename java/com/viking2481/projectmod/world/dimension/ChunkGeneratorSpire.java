package com.viking2481.projectmod.world.dimension;
...
public class ChunkGeneratorSpire implements IChunkGenerator
{
	//Block that replaces End Stone
	protected static final IBlockState MAIN_BLOCK = ModBlocks.SP_GRASS.getDefaultState();
	protected static final IBlockState OTHER_BLOCK1 = ModBlocks.SP_DIRT.getDefaultState();
    ...
    public ChunkGeneratorSpire(World world, boolean mapFeaturesEnabled, long seed, BlockPos spawn)
    {
        this.world = world;
        ...
        spawnableCreatureList.add(new SpawnListEntry(EntityMoa.class, 10, 1, 5));
        ...
        for (int i = 0; i < 16; ++i)
        {
            for (int j = 0; j < 16; ++j)
            {
                ...
                for (int i1 = 127; i1 >= 0; --i1)
                {
                    ...
                    else if (iblockstate2.getBlock() == Blocks.BEDROCK)
                    {
                        if (l == -1)
                        {
                            l = 1;
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(ModBiomes.SPIRE);
        }
    ...
    public static float getIslandHeightValue(int x, int z, int p_185960_3_, int p_185960_4_)
    {
        ...
        for (int i = -12; i <= 12; ++i)
        {
            for (int j = -12; j <= 12; ++j)
            {
                ...
                if (k * k + l * l > 4096L && ChunkGeneratorSpire.islandNoise.getValue((double)k, (double)l) < -0.8999999761581421D)
                {
