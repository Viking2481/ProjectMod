...
public class BlockLeaf extends BlockLeaves implements IMetaName, IHasModel
{
	...
	public BlockLeaf(String name) 
	{
		...
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.SA).withProperty(CHECK_DECAY, Boolean.valueOf(true)).withProperty(DECAYABLE, Boolean.valueOf(true)));
